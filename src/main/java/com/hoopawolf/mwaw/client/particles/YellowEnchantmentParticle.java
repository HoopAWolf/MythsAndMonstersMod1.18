...
public class YellowEnchantmentParticle extends TextureSheetParticle
{
    private YellowEnchantmentParticle(ClientLevel worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn)
    {
