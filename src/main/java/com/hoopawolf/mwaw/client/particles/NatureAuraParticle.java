...
@OnlyIn(Dist.CLIENT)
public class NatureAuraParticle extends TextureSheetParticle
{
    private NatureAuraParticle(ClientLevel worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn)
    {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType>
    {
        ...
        {
            NatureAuraParticle flameparticle = new NatureAuraParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
