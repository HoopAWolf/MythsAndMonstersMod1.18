...
public class YellowEnchantmentOrbitingParticle extends OrbitingParticle
{
    ...
    private YellowEnchantmentOrbitingParticle(ClientLevel worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, double spreadIn)
    {
        super(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn, spreadIn);
    }

    private YellowEnchantmentOrbitingParticle(ClientLevel worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn)
    {
    ...
    @OnlyIn(Dist.CLIENT)
    public static class YellowEnchantmentOrbiting implements ParticleProvider<SimpleParticleType>
    {
        private final SpriteSet spriteSet;

        public YellowEnchantmentOrbiting(SpriteSet p_i50441_1_)
        {
