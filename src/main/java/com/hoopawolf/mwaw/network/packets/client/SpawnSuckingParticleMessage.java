...
public class SpawnSuckingParticleMessage extends MessageToClient
{
    private Vec3 targetCoordinates, targetSpeed;
    private int iteration, particle_type;
    private double spread;

    public SpawnSuckingParticleMessage(Vec3 i_targetCoordinates, Vec3 i_targetSpeed, int _iteration, int _particle_type, double _spread)
    {
        messageIsValid = true;
        messageType = 3;
    ...
    public SpawnSuckingParticleMessage()
    {
        messageIsValid = false;
    }

    public static SpawnSuckingParticleMessage decode(FriendlyByteBuf buf)
    {
        ...
        } catch (IllegalArgumentException | IndexOutOfBoundsException e)
        {
            ...
            return new SpawnSuckingParticleMessage();
        }

        return new SpawnSuckingParticleMessage(new Vec3(x, y, z), new Vec3(speedx, speedy, speedz), iterationAmount, particletype, spreadDist);
    }
