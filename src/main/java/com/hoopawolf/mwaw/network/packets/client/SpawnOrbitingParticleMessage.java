...
public class SpawnOrbitingParticleMessage extends MessageToClient
{
    ...
    public SpawnOrbitingParticleMessage(Vec3 i_targetCoordinates, Vec3 i_targetSpeed, int _iteration, int _particle_type, double _spread)
    {
        messageIsValid = true;
        messageType = 2;
    ...
    public SpawnOrbitingParticleMessage()
    {
        messageIsValid = false;
    }

    public static SpawnOrbitingParticleMessage decode(FriendlyByteBuf buf)
    {
        ...
        return new SpawnOrbitingParticleMessage(new Vec3(x, y, z), new Vec3(speedx, speedy, speedz), iterationAmount, particletype, spreadDist);
    }
    ...
    {
        return "SpawnOrbitingParticleMessageToClient[targetCoordinates=" + targetCoordinates + "]";
    }
}
