...
public class MWAWPathNavigateGround extends GroundPathNavigation
{
    static final float EPSILON = 1.0E-8F;

    public MWAWPathNavigateGround(Mob entity, Level world)
    {
        super(entity, world);
    }
    ...
    {
        this.nodeEvaluator = new MWAWWalkNodeProcessor();
        this.nodeEvaluator.setCanPassDoors(true);
        return new MWAWPathFinder(this.nodeEvaluator, p_179679_1_);
    }
    ...
    protected void followThePath()
    {
        ...
        {
            if (path.getNodePos(i).getY() != Math.floor(entityPos.y))
            {
                pathLength = i;
                break;
            }
